const Card = ({
    ...
    return (
      <div className="mb-10 overflow-hidden rounded-2xl mx-5 bg-neutral-900 shadow-lg duration-300 hover:shadow-xl border border-neutral-700" data-aos="flip-left">
